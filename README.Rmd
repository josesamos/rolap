...
```{r, results = "asis", echo = FALSE}
pander::pandoc.table(db1$instance$dimensions$when$dimension, split.table = Inf)
pander::pandoc.table(db1$instance$dimensions$where$dimension, split.table = Inf)
pander::pandoc.table(db1$instance$facts$mrs_cause$facts, split.table = Inf)
```

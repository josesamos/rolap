...
The goal of `rolap` is to define transformations that allow you to easily obtain ROLAP (*Relational On-Line Analytical Processing*) star databases, composed by fact and dimension tables, from flat tables. 

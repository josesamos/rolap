...
For example, the `dm` class object can be used to represent the tables or to store them in any RDBMS^[The following code is configured not to run in this document to avoid the requirements of the packages being used.].

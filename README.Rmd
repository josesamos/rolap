...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/josesamos/rolap.svg?branch=master)](https://travis-ci.com/josesamos/rolap)
<!-- badges: end -->
...
As we have filtered the data, it can be seen that the dimension tables only contain the necessary data for each star database.

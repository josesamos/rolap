---
title: "Star databases export functions"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Star databases export functions}
...
This document shows the possibilities offered by the package in this context: Export an object of the `star_database` class to other formats. After presenting the object that we will use as an example and how to select it, a section is dedicated to each type of element obtained: `dm`, list of `tibble` objects, relational databases, *xlsx* and *csv* files. Finally, it finish with the conclusions.

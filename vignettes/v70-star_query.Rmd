---
title: "Performing Multidimensional Queries with Geographic Attributes"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Performing Multidimensional Queries with Geographic Attributes}
...
If there are still unrelated instances of the dimension, the `define_geoattribute()` function warns and the instances can be consulted using the `get_unrelated_instances()` function.
...
var_state_2 <- var_state |>
  dplyr::filter(year == '2016' & (region == '1' | region == '2'))
```

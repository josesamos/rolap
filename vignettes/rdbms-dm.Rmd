...
We are going to add an *Hour* field obtained from the *Time* field.
...
db_finest_dm <-
  db_dm[c('transaction_line', 'who', 'where', 'when', 'when_moment', 'what')]
```
...
ct_dm <-
  ct_dm_all[c('transaction_line', 'who', 'where', 'when', 'when_moment', 
              'what', 'transaction_summary', 'who_segment', 'where_chain')]

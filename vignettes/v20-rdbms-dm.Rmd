...
We will build on a dataset with transactional data from Czech debit card company specialising on payments at gas stations called [CCS](https://fit.cvut.cz/cs), publicly available in a RDBMS.

...
In some cases, we may be interested in having the data in the form of a flat table again, especially if we want to carry out some statistical analysis with the integrated data. We can export them as a single `tibble` list.

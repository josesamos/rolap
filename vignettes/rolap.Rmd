...
In this case it has not been considered necessary, but if desired, it is possible to rename both the names of the dimension attributes and the measures in the facts.
